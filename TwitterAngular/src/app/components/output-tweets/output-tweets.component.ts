...
@Component({selector: 'app-output-tweets', templateUrl: './output-tweets.component.html', styleUrls: ['./output-tweets.component.css']})
export class OutputTweetsComponent implements OnInit {

    constructor(private twitterPostService : TwitterPostService, private toastrService : ToastrService, private router : Router, private httpClient : HttpClient, private likeService : LikeService) {}
