...
@Component({selector: 'app-comments', templateUrl: './comments.component.html', styleUrls: ['./comments.component.css']})
export class CommentsComponent implements OnInit {

    constructor(private toastrService : ToastrService, private commentService : CommentService, private authService : AuthService, private twitterPostService : TwitterPostService) {}
    ...
    updateComment() {
        this.commentService.updateComment(this.editedComment).subscribe(response => {
